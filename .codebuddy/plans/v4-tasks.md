...
| # | 任务 | 操作主体 | 状态 |
|---|---|---|---|
| 1 | 建子目录 `studio/reference/{analysis-report,my-game}/` | 用户 PowerShell | `[ ]` |
| 2 | `Move-Item analysis-report studio/reference/` | 用户 PowerShell | `[ ]` |
| 3 | `Move-Item my-game studio/reference/` | 用户 PowerShell | `[ ]` |
| 4 | 验证：根目录无 analysis-report / my-game / `studio/reference/` 子目录就位 | 用户肉眼 | `[ ]` |
